...
folder `recipes-angular-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `recipes-angular-snapshots` folder, containing
